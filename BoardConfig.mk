...
DEVICE_PATH := device/tecno/TECNO-CI6
...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := TECNO-CI6
...
TARGET_KERNEL_CONFIG := TECNO-CI6_defconfig
TARGET_KERNEL_SOURCE := kernel/tecno/TECNO-CI6
